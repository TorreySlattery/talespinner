    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alignment', models.CharField(choices=[('LG', 'Lawful Good'), ('LN', 'Lawful Neutral'), ('LE', 'Lawful Evil'), ('NG', 'Neutral Good'), ('N', 'Neutral'), ('NE', 'Neutral Evil'), ('CG', 'Chaotic Good'), ('CN', 'Chaotic Neutral'), ('CE', 'Chaotic Evil'), ('U', 'Unaligned')], default='A', max_length=3)),
                ('current_initiative', models.SmallIntegerField(default=0)),
                ('conditions', models.ManyToManyField(blank=True, to='creatures.Condition')),
            ],
        ),
        migrations.CreateModel(
            name='EncounterGroup',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('description', models.TextField()),
                ('encounter_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='encounters', to='creatures.EncounterGroup')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('size', models.CharField(choices=[('T', 'Tiny'), ('S', 'Small'), ('M', 'Medium'), ('L', 'Large'), ('H', 'Huge'), ('C', 'Colossal'), ('G', 'Gargantuan')], default='M', max_length=5)),
                ...
                ('avg_hp', models.PositiveSmallIntegerField(default=50, help_text='The listed health')),
                ('max_hp', models.PositiveSmallIntegerField(default=1000)),
                ('alignment', models.CharField(choices=[('LG', 'Lawful Good'), ('LN', 'Lawful Neutral'), ('LE', 'Lawful Evil'), ('NG', 'Neutral Good'), ('N', 'Neutral'), ('NE', 'Neutral Evil'), ('CG', 'Chaotic Good'), ('CN', 'Chaotic Neutral'), ('CE', 'Chaotic Evil'), ('U', 'Unaligned'), ('A', 'Any alignment'), ('AG', 'Any Good'), ('AE', 'Any Evil'), ('ANL', 'Any non-lawful')], default='A', max_length=3)),
                ...
                ('condition_immunities', models.ManyToManyField(blank=True, to='creatures.Condition')),
        ...
        migrations.AddField(
            model_name='creature',
            name='encounter',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='creatures', to='creatures.Encounter'),
        ),
        migrations.AddField(
            model_name='creature',
            name='template',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='creatures', to='creatures.CreatureTemplate'),
        ),
        migrations.CreateModel(
            name='Attack',
            fields=[
                ...
                ('die_step', models.PositiveSmallIntegerField(default=6, help_text='Basically the number of sides on the die')),
                ('dmg_mod', models.SmallIntegerField(default=2)),
                ('dmg_avg', models.SmallIntegerField(default=4, help_text="For when people don't like rolling.")),
                ('dmg_type', models.CharField(choices=[('acid', 'acid'), ('bludgeoning', 'bludgeoning'), ('cold', 'cold'), ('fire', 'fire'), ('force', 'force'), ('lightning', 'lightning'), ('necrotic', 'necrotic'), ('piercing', 'piercing'), ('poison', 'poison'), ('slashing', 'slashing'), ('thunder', 'thunder')], max_length=255)),
                ('dmg_is_magic', models.BooleanField(default=False)),
                ('template', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='attacks', to='creatures.CreatureTemplate')),
            ],
        ),
        migrations.CreateModel(
            name='Action',
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('description', models.TextField(null=True)),
                ('template', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='actions', to='creatures.CreatureTemplate')),
            ],
        ),
    ]
